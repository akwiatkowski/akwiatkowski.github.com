// Ideas/Trip Planner - React component for bicycle trip ideas
        ...
        <div className="col">
            <div className="trip-card">
                <div className="trip-card-header">
                    <h5>{trip.start.name} → {trip.end.name}</h5>
                </div>
                <div className="trip-card-body">
                    <div className="mb-3">
                        ...
                        <span className="stat-badge bg-light text-dark">
                            📅 {trip.days_min === trip.days_normal ? `${trip.days_normal} dni` : `${trip.days_min}-${trip.days_normal} dni`}
                        </span>
                        {trip.elevation && (
                            <span className="stat-badge bg-light text-dark">
                                ⛰️ {trip.elevation}m
                    ...
                    <div className="mb-3">
                        <small className="d-block mb-1 fw-semibold">Dojazd pociągiem:</small>
                        <span className={`badge train-badge ${badgeClass} me-1`}>
                            🚂 Start: {trip.start.time_distance}h
                        </span>
                        <span className={`badge train-badge ${badgeClass}`}>
                            🚂 End: {trip.end.time_distance}h
                        </span>
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <small className="d-block mb-1 fw-semibold">
                          Niezaliczonych <strong>{trip.towns_not_visited}</strong> gmin.<br />
                          Aby zaliczyć jedną gminę potrzeba<br />
                          - <strong>{trip.time_cost_stats_for_new_town.time_cost_riding}h</strong> jazdy rowerem<br />
                          - <strong>{trip.time_cost_stats_for_new_town.time_cost_riding_and_train}h</strong> rower + dojazd<br />
                          - <strong>{trip.time_cost_stats_for_new_town.time_cost_with_sleeping}h</strong> z noclegiem<br />
...
const TripFilters = ({ filters, onFilterChange, availableSurfaces, availableDirections }) => {
    return (
        <div className="filters-card" style={{ overflow: "clip" }}>
            <h5 className="mb-4">🔍 Filtruj</h5>
    ...
    if (trips.length === 0) {
        return (
            <div className="empty-state">
                ...
                <p className="">Zmień filtry aby zobaczyć jakieś pomysły</p>
            </div>
        );
    }
