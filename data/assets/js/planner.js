...
this.BlogPlanner = class BlogPlanner {
  constructor() {
    this.processLands = this.processLands.bind(this);
  ...
  processPosts() {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      if (visit_months_since !== 2e308 && visit_months_since !== null && visit_months_since > 0 && visit_months_since <= 100) {
