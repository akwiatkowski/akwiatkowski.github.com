...
function PostsSection({ posts }) {
  if (posts.length === 0)
    return null;
  return /* @__PURE__ */ React.createElement("section", { className: "section" }, /* @__PURE__ */ React.createElement("h2", { className: "section-title" }, "Wyprawy"), /* @__PURE__ */ React.createElement("div", { className: "posts-list" }, posts.map((post) => /* @__PURE__ */ React.createElement("a", { key: post.slug, href: post.url, className: "post-card-link" }, /* @__PURE__ */ React.createElement("div", { className: "post-card-image-wrap" }, /* @__PURE__ */ React.createElement("img", { src: post.card_image_url, alt: post.title, className: "post-card-image", loading: "lazy" })), /* @__PURE__ */ React.createElement("div", { className: "post-card-content" }, /* @__PURE__ */ React.createElement("div", { className: "post-card-date" }, formatDate(post.date)), /* @__PURE__ */ React.createElement("h3", { className: "post-card-title" }, post.title), /* @__PURE__ */ React.createElement("div", { className: "post-card-stats" }, post.distace > 0 && /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("i", { className: "fa fa-road" }), " ", post.distace, " km"), post.time_spent > 0 && /* @__PURE__ */ React.createElement("span", null, /* @__PURE__ */ React.createElement("i", { className: "fa fa-clock-o" }), " ", post.time_spent, "h")))))));
}
