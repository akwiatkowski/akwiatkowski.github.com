...
function VisitedCard({ poi, onClose }) {
  return /* @__PURE__ */ React.createElement("div", { className: "poi-card" }, poi.photo_url && /* @__PURE__ */ React.createElement("img", { className: "poi-card-photo", src: poi.photo_url, alt: poi.photo_desc || poi.name }), /* @__PURE__ */ React.createElement("div", { className: "poi-card-body" }, /* @__PURE__ */ React.createElement("div", { className: "poi-card-name" }, poi.name), /* @__PURE__ */ React.createElement("div", { className: "poi-card-post-title" }, poi.post_title), /* @__PURE__ */ React.createElement("div", { className: "poi-card-meta" }, /* @__PURE__ */ React.createElement("span", null, poi.post_date), poi.post_distance > 0 && /* @__PURE__ */ React.createElement("span", null, poi.post_distance, "km"), poi.post_time_spent > 0 && /* @__PURE__ */ React.createElement("span", null, poi.post_time_spent, "h")), /* @__PURE__ */ React.createElement("a", { href: poi.post_url, className: "poi-card-link" }, "Otworz wpis ", /* @__PURE__ */ React.createElement("span", null, "\u2192"))));
}
function AutoCard({ poi, onClose }) {
  return /* @__PURE__ */ React.createElement("div", { className: "poi-card" }, poi.photo_url && /* @__PURE__ */ React.createElement("img", { className: "poi-card-photo", src: poi.photo_url, alt: poi.photo_desc || poi.name }), /* @__PURE__ */ React.createElement("div", { className: "poi-card-body" }, /* @__PURE__ */ React.createElement("div", { className: "poi-card-name" }, poi.name), /* @__PURE__ */ React.createElement("div", { className: "poi-card-post-title" }, poi.post_title), /* @__PURE__ */ React.createElement("div", { className: "poi-card-meta" }, /* @__PURE__ */ React.createElement("span", null, poi.post_date)), /* @__PURE__ */ React.createElement("a", { href: poi.post_url, className: "poi-card-link" }, "Otworz wpis ", /* @__PURE__ */ React.createElement("span", null, "\u2192"))));
}
