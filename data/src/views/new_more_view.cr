...
class NewMoreView < BaseView
  ...
  def content
    ...
    # Navigation URLs (generated by Router)
    data["url.tag.bicycle"] = router.tag_post_list_url("rowerem")
    data["url.tag.hike"] = router.tag_post_list_url("pieszo")
    data["url.tag.best"] = router.tag_post_list_url("najlepsze")
    data["url.map"] = router.map_url
    data["url.about"] = router.about_url
    data["url.home"] = router.home_url
