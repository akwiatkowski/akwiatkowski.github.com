...
require "./view/page_view"
require "./view/area_show_view"
require "./view/home_page_view"
require "./view/portfolio_view"
require "./view/new_more_view"
require "./view/post_view/article_view"
require "./view/photo_map/all"
require "./view/gallery_view/all"
require "./view/post_gallery_stats_view"
require "./view/markdown_page_view"
require "./view/pois_view"
require "./view/post_list_view/all"
require "./view/static_view/all"
require "./view/debug_view/all"
require "./view/dynamic_view/all"
require "./view/special_view/all"
require "./view/model_view/all"
